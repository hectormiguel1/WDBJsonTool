...
internal static class SectionsParser
{
    ...
    public static void MainSectionsToJson(WDBVariablesXIII wdbVars, Utf8JsonWriter jsonWriter)
    {
        ...
        if (WDBDicts.RecordIDs.ContainsKey(wdbVars.WDBName) && !wdbVars.IgnoreKnown)
        {
            ...
            jsonWriter.WriteString(WDBVariablesXIII.SheetNameSectionName, wdbVars.SheetName);
        ...
        jsonWriter.WriteStartArray(WDBVariablesXIII.StrtypelistSectionName);
        ...
        jsonWriter.WriteStartArray(WDBVariablesXIII.TypelistSectionName);
        ...
        // Write version data
        jsonWriter.WriteNumber(WDBVariablesXIII.VersionSectionName, SharedMethods.DeriveUIntFromSectionData(wdbVars.VersionData, 0, true));


        // Write fields data
        if (!wdbVars.IsKnown || wdbVars.IgnoreKnown) return;
        jsonWriter.WriteStartArray(WDBVariablesXIII.StructItemSectionName);
