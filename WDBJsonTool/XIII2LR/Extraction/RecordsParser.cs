...
{
    internal abstract class RecordsParser
    {
                public static List<WDBRecord> ProcessRecords(BinaryReader wdbReader, WDBVariablesXIII2LR wdbVars)
                {
                    Log.Fine($"Starting ProcessRecords for {wdbVars.RecordCount} records with {wdbVars.FieldCount} fields.");
                                        ...
                                        switch (fieldType)
                                        {
                                            ...
                                            case "s":
                                                ...
                                                else
                                                {
                                                    ...
                                                    Log.Fine($"{strArrayTypeDictKey}: {strArrayTypeStringVal}");
